...
public class RunClient {
    public static void main(String[] args)throws InterruptedException {
        ...
        String ip = "127.0.0.1";
        ClientController c1 = new ClientController(ip, 54752, "CLIENT-1");
        ClientController c2 = new ClientController(ip, 54752, "CLIENT-2");
        ClientController c3 = new ClientController(ip, 54752, "CLIENT-3");
        ClientController c4 = new ClientController(ip, 54752, "CLIENT-4");
        ClientController c5 = new ClientController(ip, 54752, "CLIENT-5");
